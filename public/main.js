...
$(document).ready(function () {
    ...
    var contractInstance = contractManager.getContractInstance();

    // Add the cards for the main collection
    contractInstance.totalSupply(function (err, result) {
        if (result) {
            var totalCards = parseInt(result);
            _reactDom2.default.render(_react2.default.createElement(OnSaleCardCollection, { totalCards: totalCards }), document.getElementById('buy-tab'));
        }
    });

    // Add the cards for private user collection
    _reactDom2.default.render(_react2.default.createElement(MyCardCollection, null), document.getElementById('my-tab'));
});
...
function init() {
    ...
    myDiagram = $(go.Diagram, "myDiagramDiv", // must be the ID or reference to div
    {
        ...
        $(go.TreeLayout, { angle: 90, nodeSpacing: 10, layerSpacing: 40, layerStyle: go.TreeLayout.LayerUniform })
    });
    ...
    myDiagram.add($(go.Part, "Table", { position: new go.Point(300, 10), selectable: false }, $(go.TextBlock, "Key", { row: 0, font: "700 14px Droid Serif, sans-serif" }), // end row 0
    $(go.Panel, "Horizontal", { row: 1, alignment: go.Spot.Left }, $(go.Shape, "Rectangle", { desiredSize: new go.Size(30, 30), fill: bluegrad, margin: 5 }), $(go.TextBlock, "Males", { font: "700 13px Droid Serif, sans-serif" })), // end row 1
    $(go.Panel, "Horizontal", { row: 2, alignment: go.Spot.Left }, $(go.Shape, "Rectangle", { desiredSize: new go.Size(30, 30), fill: pinkgrad, margin: 5 }), $(go.TextBlock, "Females", { font: "700 13px Droid Serif, sans-serif" })) // end row 2
    ));
    ...
    var tooltiptemplate = $(go.Adornment, "Auto", $(go.Shape, "Rectangle", { fill: "whitesmoke", stroke: "black" }), $(go.TextBlock, { font: "bold 8pt Helvetica, bold Arial, sans-serif",
        wrap: go.TextBlock.WrapFit,
        margin: 5 }, new go.Binding("text", "", tooltipTextConverter)));
